<template>
  <section class="bg-fourth my-10">
    <v-container class="py-15 content">
      <div>
        <span class="py-5 text-white text-h4 font-weight-bold"> Who We Are</span>
        <v-row class="mt-4">
          <v-col
            cols="12"
            sm="6"
        ...
        <v-btn color="warning" class="white--text mx-auto" data-aos="fade-up"
          >Learn More</v-btn
        >
      </div>
    </v-container>
