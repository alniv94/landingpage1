  ...
  <v-container class="bg-fourth" fluid>
    <v-row justify="space-evenly" class="ma-15">
      <v-col data-aos="fade-right" data-aos-duration="500">
        ...
        <p class="text-body-1 text-white">
          ...
          meet the specific needs of the business. By streamlining inventory
          management, Inventory ERP helps businesses optimize their operations
    ...
    <v-container>
      <v-expansion-panels variant="accordion">
        <v-expansion-panel v-for="item in items" class="text-accent">
...
const items = [
  ...
  {
    title: "How can Inventory ERP help my business save money?",
